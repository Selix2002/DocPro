...
from docpro_frontend.clients.styles.clients_styles import PAGE_BTN_ACTIVE, PAGE_BTN_NORMAL


class ClientsPaginationBar(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.setSpacing(6)
        layout.addStretch()  # leading stretch at index 0
